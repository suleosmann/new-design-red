...
const Confirmation = () => {
  ...
  return (
    <div className="bg-white flex flex-col items-center justify-center p-4">
      <h1 className="text-4xl md:text-6xl font-bold my-8 md:my-16">Congratulations</h1>
      <h2 className="text-xl md:text-2xl font-bold my-2">Your Donation</h2>
      <p className="text-3xl md:text-5xl font-bold mb-4">{currency} {totalAmount}</p>
      <p className="text-center text-xs md:text-sm mt-6 mb-6 w-full px-2 md:px-0">
